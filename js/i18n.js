  ...
  const translations = {
    id: {
      ...
      index: {
        ...
        quick_ramadan_title: "Jadwal Ramadhan",
    ...
    ar: {
      ...
      index: {
        page_title: "بوابة الثقافة الإسلامية | منبر معرفي للأمة",
        quick_about_title: "حول الموقع",
        quick_about_sub: "ملف البوابة ورؤيتها",
        quick_faq_title: "الأسئلة الشائعة",
        quick_faq_sub: "أسئلة متكررة",
        quick_donate_title: "تبرع",
        quick_donate_sub: "ادعم الدعوة العلمية",
        quick_contact_title: "تواصل",
        quick_contact_sub: "ملاحظات ونقاش",
        quick_ramadan_title: "جدول رمضان",
