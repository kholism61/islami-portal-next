(() => {
  ...
  const translations = {
    id: {
      ...
      index: {
        ...
        sidebar_palestine: "Palestina & Perjuangan",
        sidebar_fatwa: "Fatwa Dar al-Ifta",
        ...
        sidebar_palestine_history: "Sejarah & Konflik",
        sidebar_palestine_opinion: "Opini & Analisis",
        sidebar_fatwa_worship: "Fatwa Ibadah",
        sidebar_fatwa_contemporary: "Fatwa Kontemporer",
        ...
        tool_muamalah: "Muamalah Syariah",
        tool_falak: "Belajar Ilmu Falak",
    ...
    en: {
      ...
      index: {
        ...
        sidebar_palestine: "Palestine & Resistance",
        sidebar_fatwa: "Dar al-Ifta Fatwas",
        ...
        sidebar_palestine_history: "History & Conflict",
        sidebar_palestine_opinion: "Opinion & Analysis",
        sidebar_fatwa_worship: "Worship Fatwas",
        sidebar_fatwa_contemporary: "Contemporary Fatwas",
        ...
        tool_muamalah: "Islamic Muamalah",
        tool_falak: "Learn Islamic Astronomy",
    ...
    ar: {
      ...
      index: {
        ...
        sidebar_palestine: "فلسطين والمقاومة",
        sidebar_fatwa: "فتاوى دار الإفتاء",
        ...
        sidebar_palestine_history: "التاريخ والصراع",
        sidebar_palestine_opinion: "الرأي والتحليل",
        sidebar_fatwa_worship: "فتاوى العبادات",
        sidebar_fatwa_contemporary: "الفتاوى المعاصرة",
        ...
        tool_muamalah: "المعاملات الشرعية",
        tool_falak: "تعلم علم الفلك",
  ...
  const pageBindings = {
    index: [
      ...
      { selector: ".sidebar-menu > li.has-children:nth-child(15) > .sidebar-toggle .text", key: "sidebar_palestine" },
      { selector: ".sidebar-menu > li.has-children:nth-child(16) > .sidebar-toggle .text", key: "sidebar_fatwa" },
      { selector: ".sidebar-menu > li.single-item:nth-child(17) .text", key: "sidebar_mawaris" },
      { selector: ".sidebar-menu > li.single-item:nth-child(18) .text", key: "sidebar_women" },
      { selector: ".sidebar-menu > li.single-item:nth-child(19) .text", key: "sidebar_offline" },
      ...
      { selector: "a[data-filter='palestina-sejarah']", key: "sidebar_palestine_history" },
      { selector: "a[data-filter='palestina-opini']", key: "sidebar_palestine_opinion" },
      { selector: "a[data-filter='fatwa-ibadah']", key: "sidebar_fatwa_worship" },
      { selector: "a[data-filter='fatwa-kontemporer']", key: "sidebar_fatwa_contemporary" },
      ...
      { selector: ".tools-grid .tool-card:nth-child(3) h3", key: "tool_muamalah" },
      { selector: ".tools-grid .tool-card:nth-child(4) h3", key: "tool_falak" },
      { selector: ".tools-grid .tool-card:nth-child(5) h3", key: "tool_women" },
      { selector: ".tools-grid .tool-card:nth-child(6) h3", key: "tool_kaffarah" },
