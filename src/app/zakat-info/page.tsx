...
export const metadata: Metadata = {
  title: "Penjelasan Zakat | Portal Literasi Islam",
  description: "Penjelasan fiqih zakat lengkap dan ringkasan jenis-jenis zakat.",
};
...
export default function ZakatInfoPage() {
  return (
    <div className="page-zakat-info">
        ...
        <table className="zakat-table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                Zakat fitrah wajib atas setiap muslim yang memiliki kelebihan makanan pada malam
                dan hari Idul Fitri, berdasarkan hadis Ibnu Umar: “فَرَضَ رَسُولُ اللَّهِ ﷺ
                زَكَاةَ الْفِطْرِ” (HR. Bukhari dan Muslim). Wajib dikeluarkan untuk diri sendiri
                dan orang yang menjadi tanggungan. Kadar yang disepakati jumhur adalah 1 sha’
                makanan pokok setempat. Mazhab Hanafi membolehkan pembayaran dengan nilai uang,
                sedangkan Maliki, Syafi’i, dan Hanbali mewajibkan dalam bentuk makanan. Hikmahnya
                adalah tathhir (penyucian) bagi orang yang berpuasa dan ith’am (memberi makan)
                kepada fakir miskin. Waktu utama sebelum shalat Id, dan makruh menunda tanpa uzur
                syar’i.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                Wajib apabila mencapai nisab 20 dinar (≈ 85 gram emas murni) dan dimiliki selama
                satu haul, sebagaimana disepakati dalam Al-Majmu’ (An-Nawawi) dan Al-Mughni (Ibnu
                Qudamah). Kadar zakatnya 2,5%. Perhiasan wanita terdapat khilaf: Mazhab Hanafi
                mewajibkan zakat atas semua emas, termasuk perhiasan, sedangkan jumhur tidak
                mewajibkan jika digunakan secara wajar dan tidak berlebihan. Jika emas disimpan
                sebagai investasi atau tabungan, maka wajib dizakati tanpa perbedaan pendapat
                signifikan.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>Setelah 1 tahun (haul)</td>
              <td>
                Jika saham dimiliki sebagai investasi jangka panjang, zakat dihitung dari nilai
                pasar saat haul. Jika untuk perdagangan aktif (trading), maka mengikuti zakat
                perdagangan. Mayoritas ulama kontemporer mewajibkan 2,5% dari nilai bersih jika
                mencapai nisab.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                Nisab perak adalah 200 dirham (≈ 595 gram). Kadar zakatnya 2,5% setelah haul.
                Mayoritas fuqaha sepakat tentang kewajibannya. Dalam praktik kontemporer, sebagian
                lembaga fatwa lebih memilih standar emas karena nilai perak yang rendah dapat
                menyebabkan kewajiban zakat pada tingkat harta yang sangat kecil, sehingga kurang
                sejalan dengan maqashid zakat dalam menjaga keseimbangan sosial.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                Zakat penghasilan termasuk bentuk ijtihad kontemporer yang dianalogikan kepada
                zakat maal dan perdagangan. Jika total pendapatan bersih mencapai nisab setara 85
                gram emas dalam satu tahun, maka wajib 2,5%. Sebagian ulama kontemporer seperti
                Yusuf Al-Qaradawi dalam Fiqh Az-Zakah mendukung kewajiban ini berdasarkan qiyas
                kepada mal mustafad (harta yang diperoleh). Tidak disyaratkan haul atas setiap
                pemasukan, namun dihitung akumulasi tahunan atau dibayarkan secara berkala sebagai
                ta’jil.
              </td>
            </tr>

            <tr>
              <td>🛍️ Zakat Perdagangan</td>
              <td>Modal usaha + keuntungan</td>
              <td>Setara 85 gram emas</td>
              <td>2,5%</td>
              <td>Setiap 1 tahun</td>
              <td>
                Disepakati kewajibannya oleh empat mazhab. Berdasarkan atsar sahabat dan keumuman
                ayat zakat (QS. At-Taubah: 103). Cara perhitungan: seluruh nilai barang dagangan
                pada akhir haul ditambah kas dan piutang lancar, dikurangi utang jatuh tempo, lalu
                dikeluarkan 2,5%. Nisabnya setara 85 gram emas. Syaratnya adanya niat tijarah
                (perdagangan) sejak awal kepemilikan barang.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>Saat panen</td>
              <td>
                Berdasarkan hadis Nabi ﷺ (HR. Bukhari), zakat pertanian wajib ketika panen tanpa
                syarat haul. Nisabnya 5 wasaq (≈ 653 kg gabah). Kadar 10% untuk pengairan alami
                dan 5% untuk pengairan berbiaya. Mazhab Hanafi mewajibkan zakat atas seluruh hasil
                bumi tanpa syarat nisab tertentu pada sebagian riwayat, sedangkan jumhur
                mensyaratkan nisab dan jenis tertentu yang dapat disimpan.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>Setelah 1 tahun</td>
              <td>
                Berlaku pada hewan ternak yang digembalakan mayoritas waktu (sa’imah) dan tidak
                digunakan sebagai hewan pekerja. Disyaratkan haul dan mencapai nisab tertentu:
                kambing 40 ekor, sapi 30 ekor, unta 5 ekor. Kadar zakatnya berbentuk jumlah hewan
                tertentu sesuai tabel rinci dalam fiqh (lihat Al-Mughni dan Bidayatul Mujtahid).
                Disepakati oleh empat mazhab dengan perincian teknis berbeda pada beberapa batas
                jumlah.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                Rikaz adalah harta terpendam peninggalan jahiliyah yang ditemukan. Berdasarkan
                hadis: “وَفِي الرِّكَازِ الْخُمُسُ” (HR. Bukhari dan Muslim). Wajib dikeluarkan
                20% langsung saat ditemukan tanpa syarat nisab dan tanpa haul. Berbeda dengan
                ma’dan (barang tambang), yang menurut sebagian mazhab memiliki ketentuan tersendiri
                dan tidak selalu dikenakan kadar 20%.
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                Mazhab Syafi’i, Maliki, dan Hanbali mewajibkan 2,5% seperti zakat emas. Sebagian
                ulama (terutama Hanafi) mengqiyaskan dengan rikaz sehingga 20%. Tidak disyaratkan
                haul, zakat dikeluarkan saat hasil tambang diperoleh.
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <section className="fiqh-section">
        <h2 className="fiqh-title">Penjelasan Fiqih Zakat Lengkap</h2>
...
<p>Mayoritas mensunnahkan taksiran (kharsh) pada kurma dan anggur sebelum panen berdasarkan hadits bahwa Nabi ? mengutus petugas memperkirakan hasil. Attab bin Usaid meriwayatkan bahwa Nabi ? memerintahkan memperkirakan anggur seperti kurma lalu mengambil zakatnya dalam bentuk kering. Syafi’iyah dan Hanabilah menganjurkan meninggalkan sepertiga atau seperempat demi kemudahan pemilik berdasarkan hadits Sahl bin Abi Hatsmah: “Jika kalian memperkirakan maka ambillah dan tinggalkan sepertiga; jika tidak maka tinggalkan seperempat.” Hanafiyah dan Malikiyah tidak mensyaratkan meninggalkan bagian itu.</p>
...
<p>Tentang pemungut zakat sepersepuluh (‘amil al-‘usyur), pada masa Nabi ? dan Khulafaur Rasyidin, negara mengutus petugas untuk memperkirakan dan memungut zakat pertanian. Mereka mengambil sesuai kadar yang telah ditetapkan dan tidak boleh mengambil yang terbaik dari hasil pemilik. Sabda Nabi ?: “Janganlah kalian mengambil harta terbaik mereka.” menunjukkan larangan berbuat zalim dalam pemungutan.</p>
...
<p>Para ulama berbeda pendapat mengenai hukum memindahkan zakat dari satu negeri ke negeri lain. Pada asalnya, zakat didistribusikan kepada fakir miskin di negeri tempat zakat itu dipungut. Hal ini berdasarkan hadits Mu’adz bin Jabal ketika diutus ke Yaman, di mana Nabi ? bersabda bahwa zakat diambil dari orang kaya di antara mereka dan diberikan kepada orang fakir di antara mereka. Lafaz “di antara mereka” menunjukkan bahwa zakat didistribusikan di wilayah yang sama.</p>
...
<p>Mayoritas ulama membolehkan menyegerakan pembayaran zakat sebelum haul jika sudah mencapai nisab, berdasarkan riwayat bahwa Nabi ? menerima zakat dari Abbas sebelum jatuh tempo haulnya. Namun tidak boleh menyegerakan sebelum mencapai nisab, karena belum ada sebab kewajiban. Adapun mengakhirkan pembayaran zakat setelah jatuh tempo tanpa alasan yang sah adalah haram, karena zakat merupakan hak orang lain yang telah wajib ditunaikan.</p>

<p>Dalam hal pembayaran zakat dengan nilai (al-qimah), para ulama berbeda pendapat. Hanafiyyah membolehkan membayar zakat dengan nilai uang, karena tujuan zakat adalah memenuhi kebutuhan fakir miskin dan nilai uang bisa lebih bermanfaat. Jumhur ulama (Malikiyah, Syafi’iyah, dan Hanabilah) tidak membolehkan mengganti zakat dengan nilai kecuali dalam kondisi darurat atau maslahat yang jelas, karena Nabi ? menentukan jenis tertentu dalam zakat ternak dan pertanian.</p>
...
<p>Ibnu al-Humam, Kamal al-Din. <em>Fat? al-Qadir</em>. Beirut: Dar al-Fikr, tt.</p>
...
<p>Al-Marghinani, Burhan al-Din. <em>Al-Hidayah fi Sharh Bidayat al-Mubtadi</em>. Beirut: Dar Ihya’ at-Turath al-‘Arabi, tt.</p>
      ...
      <section className="zakat-cta">
        <div className="cta-box">
          ...
          <p>Hitung zakat secara mudah dan salurkan melalui lembaga resmi terpercaya.</p>

          <div className="cta-buttons">
            <Link href="/zakat" className="cta-primary">
              Mulai Hitung
            </Link>
            <a
